...
@app.route('/medico/seguimiento_diagnostico')
def seguimiento_diagnostico_medico():
    return render_template('seguimiento_de_diagnostico.html')

@app.route('/medico/historial_paciente')
def historial_paciente_medico():
    return render_template('historial_de_paciente.html')

@app.route('/admin/seguimiento_diagnostico')
def seguimiento_diagnostico_admin():
    return render_template('seguimiento_de_diagnostico.html')

@app.route('/admin/historial_paciente')
def historial_paciente_admin():
    return render_template('historial_de_paciente.html')
